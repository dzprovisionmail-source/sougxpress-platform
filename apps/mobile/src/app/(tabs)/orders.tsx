...
import CommercialStatsStrip from "@/components/orders/CommercialStatsStrip";
...
export default function OrdersGateway() {
  ...
  return (
    <View style={[styles.roleContainer, { backgroundColor: colors.bgBase }]}>
      <CommercialStatsStrip role={role as 'customer' | 'merchant' | 'courier'} />
...
const styles = StyleSheet.create({
  ...
  content: { flex: 1, paddingHorizontal: TOKENS.spacing.xl, justifyContent: 'center', alignItems: 'center' },
  iconContainer: { width: 100, height: 100, borderRadius: 50, justifyContent: 'center', alignItems: 'center', marginBottom: TOKENS.spacing.xl },
  title: { marginBottom: TOKENS.spacing.md, fontWeight: '700' },
  description: { marginBottom: TOKENS.spacing.xl, lineHeight: 24 },
  authButton: { width: '100%', marginBottom: TOKENS.spacing.xl },
  infoBanner: { flexDirection: 'row-reverse', alignItems: 'center', padding: TOKENS.spacing.md, borderRadius: TOKENS.radius.md, gap: TOKENS.spacing.sm, width: '100%' },
  infoText: { flex: 1, textAlign: 'right' },
});

...
const testNow = Date.parse("2026-09-09T12:00:00Z");
...
const promotion = promotionToHero({ id: "promo-1", store_id: "store-1", title: "عرض اليوم", image_url: image, discount_type: "percentage", discount_value: 20, starts_at: "2026-09-08T00:00:00Z", ends_at: "2026-09-10T00:00:00Z", is_active: true, created_at: "2026-09-09T00:00:00Z", stores: { name: "متجر جديد", status: "active" } }, testNow);
...
const ranked = rankAndDeduplicateHeroSlides({ founder: [], newStores: [store!], featuredStores: [store!, featuredStore!], newProducts: [product!], featuredProducts: [], promotions: [promotion!] }, testNow);
